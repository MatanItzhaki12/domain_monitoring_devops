...
from backend.DomainManagementEngine import DomainManagementEngine as DME
from backend.MonitoringSystem import MonitoringSystem as MS
import backend.logger as logger_mod

logger = logger_mod.setup_logger("backend.app")
user_manager = UM()
domain_engine = DME()
